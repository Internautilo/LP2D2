...
@section('content')
    ...
    <div
        class="container rounded-5 text-center pb-1 px-3 mb-5 text-primary-emphasis bg-dark-subtle border border-3 border-shadow">
        ...
        <div class="container text-center mx-auto px-auto my-5 py-5 ">
            <div class="row align-items-center justify-content-evenly">
                <div class="col-sm-3 card pt-2 bg-light text-dark border border-4 rounded rounded-4 border-shadow-3 ">
                    ...
                    <img src="{{ asset('img/cat-copo.webp') }}" class="img-card-top">
                    <div class="card-body">
                ...
                <div class="col-sm-3 card pt-2 bg-light text-dark border border-4 rounded rounded-4 border-shadow-3 ">
                    ...
                    <img src="{{ asset('img/cat-tampa.webp') }}" class="img-card-top">
                    <div class="card-body">
                        <h5 class="card-title">Tampa plástica descartável</h5>
                        <p class="card-text">Tampas descartáveis em poliestireno (PS) com encaixe perfeito em nossos copos.
                            Feitas para
