    ...
    <header
      ...
      <div class="col-md-3 mb-2 mb-md-0">
        <a href="{{ route('home') }}" class="d-inline-flex  ms-2 mt-1 ">
          <img src="{{ asset('img/Lojinha_logo.png') }}" class="px-2 py-2 bg-info-subtle img-thumbnail" style="height: 3rem">
        </a>
      </div>
    ...
    <div class="container-fluid">
      <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        ...
        <div class="col-md-4 text-center mt-2" style="height: 4rem">
          <img src="{{ asset('img/Lojinha_logo.png') }}" class="bg-light-subtle img-thumbnail py-2 px-2" style="height: 4rem" >
        </div>

        <ul class="nav col-md-4 justify-content-end">
          <li class="nav-item"><a href="{{ route('home') }}" class="nav-link px-2 text-body-secondary">Home</a></li>
          <li class="nav-item"><a href="{{ route('categories') }}" class="nav-link px-2 text-body-secondary">Pricing</a></li>
          <li class="nav-item"><a href="{{ url('/sobre_nos') }}" class="nav-link px-2 text-body-secondary">About</a></li>
        </ul>
      </footer>
    </div>
  </footer>
